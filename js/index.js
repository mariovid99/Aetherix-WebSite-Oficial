    ...
    es: {
        "lydia-martinez": {
            ...
            expertise: [
                ...
                { icon: "fas fa-user-tie", text: "Estrategia de Talento Humano y Analíticos" },
        ...
        "carlos-hernandez": {
            ...
            description: "Con más de 25 años de experiencia en TI, ha liderado proyectos estratégicos en distintos sectores, impulsando innovación y valor tangible. Se especializa en transformar problemáticas empresariales en soluciones efectivas y disruptivas. Actualmente promueve el uso de Inteligencia Artificial como motor de competitividad y crecimiento digital.",
            expertise: [
                { icon: "fas fa-server", text: "Servicios de TI" },
                { icon: "fas fa-project-diagram", text: "Dirección y gestión de proyectos de alto impacto" },
                { icon: "fas fa-brain", text: "Inteligencia Artificial aplicada a negocios" },
                { icon: "fas fa-lightbulb", text: "Innovación tecnológica y estratégica" },
                { icon: "fas fa-handshake", text: "Desarrollo de alianzas estratégicas" },
            ],
            achievements: [
                "Liderazgo de proyectos en empresas medianas y grandes de distintos sectores.",
                "Creación de propuestas innovadoras que generan valor tangible para los clientes.",
                "Impulso de soluciones disruptivas con base en Inteligencia Artificial.",
                "Promoción de alianzas estratégicas para fortalecer la competitividad empresarial.",
            ],
            expertiseTitle: "Áreas de Expertise",
            achievementsTitle: "Logros Destacados",
            linkedinText: "Conectar en LinkedIn"
    ...
    en: {
        "lydia-martinez": {
            ...
            expertise: [
                ...
                { icon: "fas fa-user-tie", text: "Human Talent Strategy and Analytics" },
        ...
        "carlos-hernandez": {
            ...
            description: "With over 25 years of experience in IT, he has led strategic projects in different sectors, driving innovation and tangible value. He specializes in transforming business problems into effective and disruptive solutions. Currently promotes the use of Artificial Intelligence as an engine for competitiveness and digital growth.",
            expertise: [
                { icon: "fas fa-server", text: "IT Services" },
                { icon: "fas fa-project-diagram", text: "Direction and management of high-impact projects" },
                { icon: "fas fa-brain", text: "Artificial Intelligence applied to business" },
                { icon: "fas fa-lightbulb", text: "Technological and strategic innovation" },
                { icon: "fas fa-handshake", text: "Development of strategic alliances" },
            ],
            achievements: [
                "Leadership of projects in medium and large companies from different sectors.",
                "Creation of innovative proposals that generate tangible value for clients.",
                "Promotion of disruptive solutions based on Artificial Intelligence.",
                "Promotion of strategic alliances to strengthen business competitiveness.",
            ],
            expertiseTitle: "Areas of Expertise",
            achievementsTitle: "Key Achievements",
            linkedinText: "Connect on LinkedIn"
